    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'seofy'),    //page_title
                esc_html__('Welcome', 'seofy'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'seofy'),   //page_title
                    esc_html__('Theme Plugins', 'seofy'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'seofy'),   //page_title
                esc_html__('Requirements', 'seofy'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'seofy'),   //page_title
                esc_html__('Activate Theme', 'seofy'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'seofy'),   //page_title
                esc_html__('Help Center', 'seofy'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'Seofy_Core' ) ) { 
                $submenu[] = array(
                    esc_html__('Theme Options', 'seofy'),   //page_title
                    esc_html__('Theme Options', 'seofy'),   //menu_title
                    'edit_posts',                           //capability
